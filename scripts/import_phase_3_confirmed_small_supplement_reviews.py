...
from research_foundation.phase3_small_supplement_review import import_confirmed_small_supplement_reviews
...
if __name__ == "__main__":
    ...
    result = import_confirmed_small_supplement_reviews(ROOT, args.family_prereview, args.isolation_prereview)
